...
<body>
	...
	<div class="slider-3">
		<img src="img/banner21.jpg" class="img__slider active">
		<img src="img/banner22.jpg" class="img__slider">
		<img src="img/banner23.jpeg" class="img__slider">
			<div class="suivant">
			&#10095;
			</div>
			<div class="precedent">
	...
	<section class="shop container">
		...
		<div class="shop-content">
			<div class="product-box">
				<img src="img/10.jpg" class="product-img">
			...
			<div class="product-box">
				<img src="img/11.jpg" class="product-img">
			...
			<div class="product-box">
				<img src="img/12.jpg" class="product-img">
			...
			<div class="product-box">
				<img src="img/13.jpg" class="product-img">
