...
<body>
	...
	<header>
		...
		<div>
		<div class="login-car">
			<h4 class="title_user" >Bienvenido&#10095;</h4>
		<div class="action">
			<div class="profile" onclick="menuToggle();">
				<img src="img/user.png">	
			</div>	
			<div class="menu">
				<h3><?php echo ucfirst($_SESSION['nombre']); ?><br><span>Usuario</span></h3>
				<ul>
					<li><img src="img/bag.png"><a href="">Mis compras</a></li>
					<li><img src="img/logout.png"><a style="cursor: pointer;" onclick="Logout();">Cerrar Sesión</a></li>
				</ul>
			</div>
		</div>
	...
	<script type="text/javascript" src="js/script-h-c.js"></script>
</body>
</html>